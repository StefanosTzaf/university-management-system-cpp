...
// Function to validate and return a valid student registration number
...
// Function to validate and return a valid professor registration number
...
int main(void){
    Secretary secretary;
    // Secretary setup - define graduation details
    ...
    // Add semesters to the secretary
    ...
    // Temporary objects used later for add operations
    Professor newProf;
    Course newCourse;
    Student newStudent;
    string inputToExit;
    ...
    // Read data from the corresponding files and load it into the secretary
    ...
    do{
        ...
        while(!validInput){
            try{
                ...
                // Print course statistics for a professor
